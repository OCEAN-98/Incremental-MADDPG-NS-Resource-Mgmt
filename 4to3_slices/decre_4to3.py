...
load_dir = '/Users/ocean/git/NetworkSlicing/4_slices/models'
...
agent_0_actor.load_state_dict(avg_weights)
agent_1_actor.load_state_dict(avg_weights)
agent_2_actor.load_state_dict(avg_weights)
...
agent_0_critic.load_state_dict(avg_weights)
agent_1_critic.load_state_dict(avg_weights)
agent_2_critic.load_state_dict(avg_weights)
agent_0_critic.save()
agent_1_critic.save()
agent_2_critic.save()
