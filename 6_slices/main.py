...
network = NetworkSetup(incremental_number=6)
network.reset()
alpha = 0.001
beta = 0.001
...
n_agents = 6
actor_dims = [10, 10, 10, 10, 10, 10]  # each 8 represent the observation of a slice (4 resource + 4 requests)
critic_dims = 7 + (5 + 1) * 6 # 5 + 1 # len of x, len of edge_attr
n_actions = 5
# INITIAL_EPSILON = 0.5 # here we will use greedy policy
# FINAL_EPSILON = 0.001
# epsilon = 0.15
Episodes = 1
Observe = 10000
